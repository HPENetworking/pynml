...
for generated in ['nml', 'exceptions']:
    target = (
    ...
    if not target.exists():
        raise RuntimeError(
            'Autogenerated file {}.py is missing. '
            'Please build the package first. '.format(generated)
        )
